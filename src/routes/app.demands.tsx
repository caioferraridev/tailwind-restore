...
const STATUSES = [
  ...
  { value: "aguardando_cliente", label: "Aguardando cliente", color: "bg-warning/20 text-warning-foreground" },
  { value: "em_revisao", label: "Em revisão", color: "bg-accent text-accent-foreground" },
  { value: "finalizado", label: "Finalizado", color: "bg-success/15 text-success" },
  { value: "atrasado", label: "Atrasado", color: "bg-destructive/15 text-destructive" },
] as const;
    ...
    <DialogContent>
      ...
      <form onSubmit={handleSave} className="space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5 sm:col-span-2"><Label>Valor (R$)</Label>
